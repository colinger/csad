...
public class PermissionsUtil {
     ...
     */
    public static void requestPermission(Context activity, PermissionListener listener, String... permission) {
     ...
     */
    public static void requestPermission(@NonNull Context activity, @NonNull PermissionListener listener
