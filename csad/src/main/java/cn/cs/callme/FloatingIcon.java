...
public class FloatingIcon extends TextView {
     ...
     */
    public FloatingIcon setActivity(Activity activity) {
     ...
     */
    public FloatingIcon setMovingRange(int widthPixels, int heightPixels) {
     ...
     */
    public FloatingIcon setSpeed(int speed) {
        this.speed *= (11 - speed);
        return this;
    }
